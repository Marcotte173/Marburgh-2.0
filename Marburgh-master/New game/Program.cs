...
namespace New_game
{
    class Program
    {
        ...
        public static pClass[] MonsterClassList = new pClass[] { new pClass("Slime", 7, 3, 0, 0), new pClass("Goblin", 5, 4, 0, 0), new pClass("Kobald", 6, 3, 0, 0),  new pClass("Skeleton", 8, 5, 0, 0), new pClass("Orc", 10, 6, 0, 0),
            new pClass("Minotaur", 20, 13, 0, 0), new pClass("Ogre", 25, 15, 0, 0),new pClass("Hell Hound", 15, 5, 0, 0), new pClass("Savage Orc", 80, 25, 0, 0), new pClass("Giant Ogre", 110, 35, 0, 0), new pClass("Marcotte", 150, 50, 0, 0) };
        ...
        private readonly static Boss[] bossList = new Boss[] { //HP,DM,HT,CRT,STN,DEF,SP,XP,GOLD
            new Boss("Savage Orc", "'NOW YOU WILL DIE'", MonsterClassList[9],300,25 , " Savage Orc", true),
            new Boss("Ogre","'*He just stares at you before attacking*", MonsterClassList[10],300,25, "n Ogre", true),
            new Boss("Marcotte", "*Snort*",MonsterClassList[11],0,0, " Minotaur",  true)};


        private readonly static Monster[] monsterList = new Monster[] { new Monster("Slime", "*Squish*", MonsterClassList[0], 35, 4, " Slime"),
            new Monster("Goblin", "Scatter!", MonsterClassList[1], 45, 3, " Goblin"), new Monster("Kobald", "Leave my candles alone!", MonsterClassList[2], 35, 3, " Kobald"),
            new Monster("Skeleton", "*Creak*", MonsterClassList[3], 40, 4, " Skeleton"), new Monster("Orc", "You're dead!", MonsterClassList[4], 49, 5, "n Orc"), new Monster("Ogre", "RAAAWR", MonsterClassList[6], 110, 10, " Ogre"),
            new Monster("Minotaur", "*Snort*", MonsterClassList[5], 100, 8, " Minotaur"), new Monster("Hell Hound", "'Bark! Bark!'", MonsterClassList[7], 80,7," Hell Hound")};


        public static Event[] SearchList = new Event[] {new Event("Gold",  "Some gold",        1 ,     150,           50),
        ...
        //Dungeons                                              Name            Flavor         BossRoom                 List of possible Rooms         Boss of dungeon    Available?          Monster List
        public static Dungeon Dungeon1 = new Dungeon("Starter dungeon", "YOU ARE IN DUNGEON 1", 5, 60, new Room[] { RoomList[0], RoomList[1], RoomList[2], RoomList[3] }, bossList[0], true, new Monster[] { monsterList[0], monsterList[1], monsterList[2] }, 1, 1, false);
        public static Dungeon Dungeon2 = new Dungeon("Second Dungeon", "YOU ARE IN DUNGEON 2", 8, 70, new Room[] { RoomList[0], RoomList[1], RoomList[2], RoomList[3], RoomList[4] }, bossList[1], false, new Monster[] { monsterList[0], monsterList[1], monsterList[2], monsterList[3] }, 1, 1, false);
        ...
        public static void CharacterSelectConfirm(Creature p)
        {
        ...
        public static void DungeonSearch()
        {
            p.fights--;
            Console.WriteLine("\n\nYou find...");
        ...
        public static void MonsterSummon()
        {
            Thread.Sleep(300);
        ...
        public static void ShopBuy(Equipment equip, Equipment playerEquip)
        {
        ...
        public static void GameDungeon()
        {
            Console.Clear();
